        ...
        <div class="chat-header">
            <div class="header-content">
                <div class="chat-title">
                    <h1>AI Assistant</h1>
                    <p class="subtitle">Query your project documents with SOP compliance</p>
                </div>
        ...
        <div class="chat-messages" ref="messagesContainer">
            <div v-if="!questions.length" class="empty-chat">
                <div class="empty-content">
                    ...
                    <p>Ask questions about your project documents or get help with SOP compliance.</p>
                </div>
            </div>

            <div v-for="(question, index) in questions" :key="index" :class="['message', question.type === 'question' ? 'user-message' : 'ai-message']">
        ...
        <div v-if="showFileModal" class="modal-overlay" @click="closeFileModal">
            <div class="modal-content" @click.stop>
                ...
                <div class="modal-footer">
                    <button @click="closeFileModal" class="btn-modern btn-secondary">Cancel</button>
                    <button @click="applyFileSelection" class="btn-modern btn-primary">Apply Selection</button>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        async loadProjectFiles() {
            ...
            try {
                const response = await axios.get(`/api/projects/${this.selectedProject}/files`);
    ...
    .chat-messages {
        ...
        .message {
            ...
            .message-content {
                ...
                .message-sources, .sop-references {
                    margin-top: 1rem;
                    padding-top: 1rem;
