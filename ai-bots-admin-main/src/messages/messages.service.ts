...
export class MessagesService {
    ...
    public async createNewMessage(payload: { unique_id: string, conversation_unique_id: string, bot_id?: number, previous_message_id?: number, text: string, type: MessageTypes }) {        
