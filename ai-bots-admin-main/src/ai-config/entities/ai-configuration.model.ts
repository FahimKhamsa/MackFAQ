...
export class AIConfiguration extends Model<AIConfiguration> {
    ...
    @Column({
        type: DataType.TEXT,
        allowNull: false,
        defaultValue: 'You are a helpful AI assistant for project management and document analysis. Provide accurate, professional responses based on the uploaded documents and company SOPs.',
    })
